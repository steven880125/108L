...
if($_POST){
	...
	try{
        ...
        $form->Textbox0 = $Textbox0;
		$form->Textbox1 = $Textbox1;
		$form->Textbox2 = $Textbox2;
    ...
    <div class="row">
      ...
      <div class="col-md-12 order-md-1">
        ...
        <form class="needs-validation" method="POST" action="./index.php">
		  ...
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="loc">出差地點</label>
                  <input name="loc" type="text" class="form-control" id="msg" placeholder="" value="" required>
              </div>
          </div>
		  
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="days">出差天數</label>
                  <input name="days" type="text" class="form-control" id="msg" placeholder="" value="" required>
              </div>
          </div>
          
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="tra">車馬費</label>
                  <input name="tra" type="text" class="form-control" id="msg" placeholder="" value="" required>
              </div>
          </div>
		  
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="room">住宿費</label>
                  <input name="room" type="text" class="form-control" id="msg" placeholder="" value="" required>
              </div>
          </div>
